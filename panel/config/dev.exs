...
config :e_any_panel, EAnyPanelWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "NucR5cfNOeJBsyF+VwL3zpdLNxTmAWt4qzki2p4sIxi76vRZbfZtDkl5pWZBPXE+",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:e_any_panel, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:e_any_panel, ~w(--watch)]}
  ]
...
config :e_any_panel, EAnyPanelWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/e_any_panel_web/(?:controllers|live|components|router)/?.*\.(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :e_any_panel, dev_routes: true
